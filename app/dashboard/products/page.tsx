        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="carbonFootprint">Carbon Footprint (kg CO₂/kg) *</Label>
                  <Input
                    id="carbonFootprint"
                    type="number"
                    step="0.01"
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleInputChange('isRawMaterial', checked as boolean)}
                />
          ...
          <Card key={product._id?.toString()} className="hover:shadow-md transition-shadow">
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Badge variant={product.isRawMaterial ? "default" : "secondary"}>
            ...
            <CardContent>
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="truncate max-w-[150px]" title={product.manufacturingAddress}>
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-muted-foreground text-center mb-4">
              {searchTerm ? "No products match your search criteria." : "Get started by registering your first product."}
            </p>
            {!searchTerm && (
